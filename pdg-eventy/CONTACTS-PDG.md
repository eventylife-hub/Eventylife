...
## Contacts à trouver en priorité

| Rôle | Pourquoi | Urgence | Statut |
|------|----------|---------|--------|
| Avocat spécialisé tourisme | Statuts SAS + CGV + contrats partenaires | **Semaine 1** | À trouver |
| Expert-comptable tourisme | TVA marge, IS, facturation, Atout France | **Semaine 1-2** | 📧 Devis demandés (Chevalier + Nexco) |
| APST (contact dossier) | Garantie financière 200K€ | **Semaine 2** | 📧 Email envoyé |
| Banque pro (Qonto/Shine/BPI) | Compte + découvert + prêt | **Semaine 2** | À comparer |
| Assureur RC Pro | Couverture obligatoire agence voyages | **Semaine 2-3** | 📧 Devis demandés (CMB + Hiscox) |

## Partenaires à démarcher

| Type | Cible | Urgence | Statut |
|------|-------|---------|--------|
| Hôtels / Gîtes | 3 premiers partenaires | Semaine 4-6 | À démarcher |
| Autocaristes | 2 prestataires transport groupes | Semaine 4-6 | À démarcher |
| Prestataires activités | 3 prestataires pour programmes | Semaine 4-6 | À démarcher |
| Assureur voyage groupes | Contrat cadre assurance clients | Semaine 4-6 | 📧 Devis demandé (Mutuaide) |
...
| **Atout France** | Immatriculation agence | atout-france.fr | 100€ frais. Nouvelles conditions depuis mars 2026 | 2026-03-05 | Après APST + RC Pro |
| **Scaleway** | Hébergement cloud | scaleway.com | DEV1-S ~6,42€ HT/mois. Datacenter français | 2026-03-05 | À souscrire (déploiement) |
| **AXA Pro** | RC Pro alternative | axa.fr | Assureur généraliste, offre pro disponible | 2026-03-05 | Option de secours |
| **MMA** | RC Pro alternative | mma.fr | Assureur généraliste, offre pro disponible | 2026-03-05 | Option de secours |
| **Generali** | RC Pro alternative | generali.fr | Assureur généraliste, offre tourisme | 2026-03-05 | Option de secours |
