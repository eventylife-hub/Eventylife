  ...
  return (
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="space-y-3">
        {[...Array(6)].map((_, i) => (
          <div key={i} style={{ height: 64, borderRadius: 8, background: 'linear-gradient(90deg, #E5E0D8 25%, #F0ECE6 50%, #E5E0D8 75%)', backgroundSize: '200% 100%', animation: 'shimmer 1.5s infinite' }} />
        ))}
      </div>
    </div>
  </>
