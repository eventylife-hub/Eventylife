  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 animate-fade-up">
      ...
      <div className="rounded-2xl p-6" style={{ background: '#fff', border: '1.5px solid #E5E0D8' }}>
        ...
        <form aria-label="Modifier le profil" onSubmit={handleSubmit} className="space-y-6" noValidate>
          {/* Email (lecture seule) */}
          <div>
      ...
      {showPasswordModal && (
        ...
        >
          <div className="rounded-2xl p-6 w-full max-w-md" style={{ background: '#fff' }}>
            ...
            <form aria-label="Changer le mot de passe" onSubmit={handleChangePassword} className="space-y-4" noValidate>
              <div>
